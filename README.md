...
📖 **[Guida per chi studia](docs/14-User-Manual.md)**
...
| `node tools/banchi/audit_rete.js` | Semina un valore spia nei dati dell'utente e verifica che non esca in nessuna richiesta |
| `node tools/banchi/audit_mobile.js` | Verifica che a 390 px la pagina non scorra in orizzontale |
| `node tools/banchi/audit_copertura.js` | Misura quanti byte di JavaScript vengono davvero eseguiti |
...
I 43 banchi stanno in [`tools/banchi/`](tools/banchi/) e sono versionati:
...
Procedura completa, alternative e ripristino: [Guida al deploy](docs/12-Deploy-Guide.md).
...
Dettagli: [Documentazione dei test](docs/15-Test-Documentation.md).
...
[`docs/07-SBOM.md`](docs/07-SBOM.md), attribuzioni in
...
> [`docs/09-Release-Conformance-Statement.md`](docs/09-Release-Conformance-Statement.md).
