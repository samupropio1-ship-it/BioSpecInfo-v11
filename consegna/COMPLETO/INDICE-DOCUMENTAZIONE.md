...
[`docs/candidatura/`](https://github.com/samupropio1-ship-it/BioSpecInfo-v11/tree/main/docs/candidatura) — completa i campi tra `[…]` prima di inviare.

**🤖 Scheda progetto Spectra** (agente AI, pronta per il colloquio):
[`docs/candidatura/pdf/Progetto-Spectra-Colloquio.pdf`](https://github.com/samupropio1-ship-it/BioSpecInfo-v11/blob/main/docs/candidatura/pdf/Progetto-Spectra-Colloquio.pdf) — 3 pagine.
