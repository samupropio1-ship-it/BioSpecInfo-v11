...
| 05 | [AI Agent Architecture "Spectra"](05-AI-Agent-Architecture.md) | Agentic loop, 35 tools, engineering decisions, numeric verification |
| 06 | [Scientific Accuracy and Data Provenance](06-Scientific-Accuracy-Data-Provenance.md) | How the chemical data are verified, the structure ⟷ molecular weight method, declared limits of the predictors |
